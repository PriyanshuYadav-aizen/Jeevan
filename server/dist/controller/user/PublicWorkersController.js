        ...
        try {
            ...
            if (role) {
                ...
                const [nurses, caretakers, compounders] = yield Promise.all([
                    nurse_1.default.find().select("username phone address profilePicture role createdAt hourlyRate dailyRate weeklyRate isAvailable").lean(),
                    caretaker_1.default.find().select("username phone address profilePicture role createdAt hourlyRate dailyRate weeklyRate isAvailable").lean(),
                    compounder_1.default.find().select("username phone address profilePicture role createdAt hourlyRate dailyRate weeklyRate isAvailable").lean(),
                ]);
